...
import com.example.library_system.security.AppUserDetailsService;
import com.example.library_system.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/password-reset/**", "/api/customer/password-reset/**").permitAll()
                        ...
                        .requestMatchers("/api/book-requests/pending", "/api/book-requests/approve/**", "/api/book-requests/reject/**")
                        .hasRole("ADMIN")
